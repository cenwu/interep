...
<!-- [![CRAN RStudio mirror downloads](http://cranlogs.r-pkg.org/badges/interep)](http://www.r-pkg.org/pkg:443/interep) -->

[![Travis build
status](https://travis-ci.org/feizhoustat/interep.svg?branch=master)](https://app.travis-ci.com/cenwu/interep)
[![CRAN
status](https://www.r-pkg.org/badges/version/interep)](https://CRAN.R-project.org/package=interep)
[![Codecov test
coverage](https://codecov.io/gh/cenwu/interep/branch/master/graph/badge.svg)](https://app.codecov.io/gh/cenwu/interep?branch=master)
<!-- badges: end -->
...
Example codes can be found from 
